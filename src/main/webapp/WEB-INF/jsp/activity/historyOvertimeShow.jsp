...
<div>
       ...
       <table class="table table-striped table-bordered table-hover  table-condensed">
                ...
                <fmt:formatDate value="${message.leaderCreateDate }" var="leaderCreateDate" pattern="yyyy-MM-dd HH:mm" />
                <fmt:formatDate value="${message.managerCreateDate }" var="managerCreateDate" pattern="yyyy-MM-dd HH:mm" />
               <tbody>
                    <tr>
