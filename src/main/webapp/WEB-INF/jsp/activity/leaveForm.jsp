             ...
             <li><a href="">请假申请</a></li>
              ...
              <div class="panel-heading">请假申请</div>
                 <div class="panel-body">
                   <form:form commandName="messageProcess" action="/OfficeAutomation/home/leaveForm/startLeaveProcess" method="post">
                      <table class="addTable">
                       <tr>
                         <td>请假类型</td>
                         <td><form:select path="type" id="type" cssClass="form-control">
